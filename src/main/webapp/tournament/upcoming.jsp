...
<body style="background-color: #f8f9fa !important;">
    ...
    <main role="main" class="container"> 
    	...
    	<%
	    	...
	    	String query="SELECT t1.TeamName,t2.TeamName,date,time,location.name from match_dlt join location on location.id=match_dlt.location JOIN team_mst AS t1 ON t1.TeamID=team1 JOIN team_mst AS t2 ON t2.TeamID=team2 where isPlayed=0";
